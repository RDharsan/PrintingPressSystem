 		...
 		<form action="income.jsp" method="POST">
		 			...
		 			<div>
		 				<select name="type" class="form-control" onchange="this.form.submit();">
				 			...
				 			try {
				 				...
				 				ResultSet rs = stm.executeQuery("select distinct type from income_history");
				 				while(rs.next()){
				 					%>
	 		...
	 		<table id="tbl-expense" class="table table-responsive table-bordered tbl-contain" cellpadding="0" width="100%">
		 			<thead>
						...
						if (type.equals("all")){
							System.out.print("1");
							String sql ="SELECT * FROM income_history";
							System.out.print("2");
							...
							pst = connection.prepareStatement("select * from income_history where type=?");
