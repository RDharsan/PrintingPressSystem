...
<div id="header"><img src="veena.jpg" alt="" class="img"></div>
 ...
 <div class="main_content">
   <div class="header"> Delete Driver</div>
...
%>
     ...
     <form action="delete1" method="post">
        ...
        <tr>
         <td>Driver Name</td>
         <td><input class="patname" type="text" name="drivername" value="<%=drivername %>" readonly><br></td>
        </tr>
        
         <tr>
		  <td>NIC </td>
		  <td><input class="patname" type="text" name="nic " value="<%=nic %>" readonly><br></td>
		
		</tr>
		
		 <tr>
		  <td>Team</td> 
		  <td><input class="patname" type="text" name="team" value="<%=team %>" readonly><br></td>
		
		 </tr>
		 
		  <tr>
		  <td>Vehicle</td>
		  <td><input class="patname"  type="text" name="vehicle" value="<%=vehicle %>" readonly><br></td>
		
		 </tr>
		 
		  <tr>
		  <td>Phone</td> 
		  <td><input class="patname" type="text" name="phone" value="<%=phone %>" readonly><br></td>
 ...
 <br>
       <input class="btn" type="submit" name="submit" value="Delete Driver"><br>
