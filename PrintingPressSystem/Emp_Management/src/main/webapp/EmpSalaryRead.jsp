    ...
    <ul>
  	   ...
  	   <li><a href="../../LoginAndHome/Home.jsp"><img src="home.png" width="20" height="20"/><br>HOME</a></li>
 			...
 			<div class="row" style="margin-right:25%">
				 ...
				 <div class="colum" >
				 <h2 align="center" style="margin-top:10%;margin-left:35%">Employee Salary Details</h2>
				 		 ...
				 		 <thread>
				    		...
				    		con = DriverManager.getConnection("jdbc:mysql://localhost:3306/newveenaprinters","root","dharsanravi.33");
				 			...
				 			<tr>
				 				...
				 				<td><%=rs.getString("overtime_salary") %></td>
				 				<td><%=rs.getString("leaves_charge") %></td>
				 				<td><%=rs.getString("total_salary") %></td>
				 				<td><a href="EmpSalaryUpdate.jsp?id=<%=id%>"><input  type="Button" class="btn edit" name="edit" value="EDIT" id="edit" ></a></td>
				 				<td><a href="EmpSalaryDelete.jsp?id=<%=id%>"><input  type="Button" class="btn delete" name="delete" value="DELETE" id="delete" ></a></td>
